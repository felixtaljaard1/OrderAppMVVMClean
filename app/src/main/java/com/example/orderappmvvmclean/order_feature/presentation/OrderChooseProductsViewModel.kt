...
import com.example.orderappmvvmclean.order_feature.presentation.mapper.toBoughtProduct
import com.example.orderappmvvmclean.order_feature.presentation.mapper.toProductListItem
...
class OrderChooseProductsViewModel @Inject constructor(
    ...
    fun onPlusClick(productId:String){
        ...
        val currentSelectedAmount = productsToShow[index].selectedAmount

        productsToShow[index] = productsToShow[index].copy(
            selectedAmount = currentSelectedAmount +1
        )
    ...
    fun onMinusClick(productId: String){
        ...
        if(currentSelectionAmount ==1){
            selectedProducts = selectedProducts.toMutableStateList().apply {
